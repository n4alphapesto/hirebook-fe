...
import {
    Grid, Box, Typography, TextField, Button, FormControl,
    RadioGroup,
    FormControlLabel,
    Radio,
    makeStyles,
...
const Signup = ({ isSigning, actions }) => {
    ...
    const onSubmit = (e) => {
        ...
        actions.register({ email, password, name, userType })
            .then(result => {
                _setShowOTP(true);
            })
    }
                    ...
                    <form onSubmit={onSubmit}>
                        <Grid item >
                            <Box mt={5}>
                                ...
                                <FormControl>
                                    <RadioGroup row name="userType" value={userType} onChange={({ target }) => _setUserType(target.value)}>
                                        <FormControlLabel
                                            value="jobseeker"
                        ...
                        <Box mt={2}>
                            <Button fullWidth disabled={showOTP} type="submit" variant="contained" color="primary" >
                                {isSigning &&
                        ...
                        <Grid item>
                            <Box mt={5}>
                                <Typography variant="content">
                                    We have sent an OTP to above email address. Please check your Inbox and enter that OTP below.
                                </Typography>
                            </Box>
                            <Box align="right">
                            ...
                            <Box mt={3}>
                                <Button fullWidth variant="contained" color="primary" onClick={verifyOTP}>
                                    Verify
                                </Button>
                            </Box>
                        </Grid>
