...
export default function userReducer(state = initialState, action) {
    ...
    switch (type) {
        case USER_LOGIN.ON_REQUEST:
            return { ...state, isLogging: true, loginErrorMsg: null, userDetails: null };
        case USER_LOGIN.ON_SUCCESS:
            return { ...state, isLogging: 'done', loginErrorMsg: null, userDetails: payload };
        case USER_LOGIN.ON_ERROR:
            return { ...state, isLogging: true, loginErrorMsg: payload, userDetails: null };
